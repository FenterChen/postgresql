                    ...
                    <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                        <div class="sm:flex sm:items-start">
                            <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                ...
                                <div class="mt-2">
                                    <label for="editEquipment"
                                           class="block text-sm font-medium text-gray-700">editEquipment</label>
                                    <input v-if="editId" v-model="editId.equipment"
                                           type="text"
                                           name="editEquipment"
                                           id="editEquipment"
                                           class="
              ...
              "
                        ...
                        <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                            <div class="mx-2 my-5">
                                <div class="input-group flex mb-4">
                                    <input type="search" v-model="newEquip" class="form-control flex-auto min-w-0 block px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-400 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-gray-500 focus:outline-none" aria-label="Search" aria-describedby="button-addon3">
                                    <button @click="Add" class="px-6 py-2 w-1/4 bg-gray-400 border-2 border-gray-500 text-white font-bold text-l leading-tight rounded hover:bg-black hover:bg-gray-600" type="button" id="button-addon3">Add Equipment</button>
                                </div>
                            </div>
                ...
                ">
                  ...
                  ">
                                ...
                                <tbody>
                                    <tr v-for="item in userContent.userEquipments" :key="item.equipment"
                                        class="
                      bg-white
                      border-b
                    ...
                    ">
                      ...
                      ">
                                            {{item.equipment}}
                                            <button @click="useEquipment(item)" class="px-4 py-2  mx-1 font-bold bg-regal-blue text-white rounded-full">Use</button>
                                        </th>
                                        <td class="px-6 py-4 text-right border-l-2">
                                            <button @click="editCheck(item)" class="my-2 md:my-0 px-4 py-2 mx-2 font-bold bg-cyan text-white rounded-full">Edit</button>
                                            <button @click="deleteCheck(item.equipmentid)" class="px-4 py-2 mx-2 font-bold bg-red-500 text-white rounded-full">Delete</button>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                    ...
                    <div class="px-4 py-3 bg-gray-50 flex justify-between sm:px-6" v-if="infoIsclick">
                        <button @click="save" 
                                class="
                justify-center
                py-2
...
<script>
    ...
    export default {
        setup() {
            ...
            const Add = () => {
                axios.post('api/Gameusers/adduserdata', {
