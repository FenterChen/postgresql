                        ...
                        <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                            <div class="mx-2 my-5">
                                <div class="input-group flex mb-4">
                                    ...
                                    <button @click="Add" class="px-6 py-2 w-1/4 bg-gray-400 border-2 border-gray-500 text-white font-bold text-l leading-tight rounded hover:bg-gray hover:bg-gray-600" type="button" id="button-addon3">Add Equipment</button>
                                </div>
                            </div>
